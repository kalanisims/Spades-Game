...
export default function App() {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16, width: "100%", maxWidth: 380 }}>
        ...
        <button
          ...
          style={{
            ...
            transition: "all 0.2s", color: "#e8dfc8",
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <div style={{
              fontSize: 48, width: 64, height: 64,
              background: "#0a1a0c", borderRadius: 12,
              display: "flex", alignItems: "center", justifyContent: "center",
              border: "1px solid #1a4a28", flexShrink: 0
            }}>♠</div>
            <div>
              ...
              <div style={{ fontSize: 12, color: "#6a9a7a", lineHeight: 1.6 }}>
                Classic trick-taking card game.<br />
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <div style={{
              ...
              background: "#0a101a", borderRadius: 12,
              display: "flex", alignItems: "center", justifyContent: "center",
              border: "1px solid #1a2a4a", flexShrink: 0
            }}>⚔️🌸</div>
            <div>
      ...
      <div style={{ marginTop: 48, color: "#2a4a3a", fontSize: 11, letterSpacing: 2 }}>
